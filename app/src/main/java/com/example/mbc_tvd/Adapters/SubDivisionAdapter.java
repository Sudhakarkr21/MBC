...
public class SubDivisionAdapter extends BaseAdapter {
    private ArrayList<GetSetValues> arrayList = new ArrayList<>();
    private Context context;
    private LayoutInflater inflater;

    public SubDivisionAdapter(ArrayList<GetSetValues> arrayList, Context context) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        tv_role.setText(arrayList.get(position).getSubdivisionname());
        return convertView;
    }
}
